...
# 1 "spriteMario.h" 1
# 21 "spriteMario.h"
extern const unsigned short spriteMarioTiles[16384];


extern const unsigned short spriteMarioPal[256];
# 14 "main.c" 2
# 1 "skybgg.h" 1
# 22 "skybgg.h"
...
extern const unsigned int ThemeSong_sampleRate;
extern const unsigned int ThemeSong_length;
extern const signed char ThemeSong_data[];
# 17 "main.c" 2
# 1 "instructions.h" 1
# 22 "instructions.h"
extern const unsigned short instructionsTiles[14560];
...
void goToStart() {
    initGame();
    DMANow(3, GameFrontPal, ((unsigned short *)0x5000000), 256);
    (*(volatile unsigned short*)0x4000008) = ((0)<<2) | ((28)<<8) | (1<<7) | (0<<14);
    DMANow(3, GameFrontTiles, &((charblock *)0x6000000)[0], 19072);
    DMANow(3, GameFrontMap, &((screenblock *)0x6000000)[28], 1024);
    state = START;
    DMANow(3, spriteMarioPal, ((unsigned short *)0x5000200), 256);
    DMANow(3, spriteMarioTiles, &((charblock *)0x6000000)[4], 16384);
    hideSprites();
...
void goToInstruct() {
    ...
    (*(volatile unsigned short*)0x4000008) = ((0)<<2) | ((28)<<8) | (1<<7) | (0<<14);
    DMANow(3, instructionsTiles, &((charblock *)0x6000000)[0], 14560);
    DMANow(3, instructionsMap, &((screenblock *)0x6000000)[28], 1024);
    state = INSTRUCTIONS;
    hideSprites();
    DMANow(3, shadowOAM, ((OBJ_ATTR*)(0x7000000)), 128*4);
}
...
void goToGame() {
    ...
    DMANow(3, skybggPal, ((unsigned short *)0x5000000), 256);
    DMANow(3, skybggTiles, &((charblock *)0x6000000)[0] ,7168);
    DMANow(3, skybggMap, &((screenblock *)0x6000000)[28], 1024);
    (*(volatile unsigned short*)0x4000008) = ((1)<<2) | ((14)<<8) | (1<<7) | (0<<14);
    DMANow(3, mainBGTiles, &((charblock *)0x6000000)[1], 4640);
    DMANow(3, mainBGMap, &((screenblock *)0x6000000)[14], 1024);
    state = GAME;
...
void goToPause() {
    ...
    (*(volatile unsigned short*)0x4000008) = ((1)<<2) | ((14)<<8) | (1<<7) | (0<<14);
    DMANow(3, pauseTiles, &((charblock *)0x6000000)[1], 5088);
    DMANow(3, pauseMap, &((screenblock *)0x6000000)[14], 1024);
    state = PAUSE;
    hideSprites();
    DMANow(3, shadowOAM, ((OBJ_ATTR*)(0x7000000)), 128*4);
}
...
void goToLose() {
    hOff = 0;
    (*(volatile unsigned short *)0x04000010) = hOff;
    DMANow(3, loserPal, ((unsigned short *)0x5000000), 256);
    (*(volatile unsigned short*)0x4000008) = ((0)<<2) | ((28)<<8) | (1<<7) | (0<<14);
    DMANow(3, loserTiles, &((charblock *)0x6000000)[0], 6880);
    DMANow(3, loserMap, &((screenblock *)0x6000000)[28], 1024);
    state = LOSE;
    stopSound();
    hideSprites();
    DMANow(3, shadowOAM, ((OBJ_ATTR*)(0x7000000)), 128*4);
